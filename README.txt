...
==	Projekt.tex		ist die Huelle und das eigtl. Startskript fuer alle
...
==	inhalte/*		Inhalte, die eure Arbeit betreffen, vom Titelblatt zum Vorwort
					bis zur Schriftwahl und zum Eid.
==	layout/*		In der dort enthaltenen format.tex befinden sich Definitionen zum
					grundlegenden Verhalten des Layouts eures Dokuments; die Praeambel.
==	texniccenter/*	Die Latex-Dateien wurden als TexnicCenter-Projekt angelegt,
					was in der Verwendung mit diesem Editor einige Bequemlichkeiten mit
					sich bringt (http://www.toolscenter.org/).
